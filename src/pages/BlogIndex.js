...
export default ({
 ...
 text = "Welcome Jafaran",

  posts = [
    {
      imageSrc:
        "https://source.unsplash.com/cAuANa0VvGw",
      
      
      title: "Get an headstart into understanding the different cyberthreats and how you can protect yourself.",
      description:
...
const whatIsRansomware = () => ({
  ...
  const ProtectingBiz = () => ({
    imageSrc:
      "https://file.rendit.io/n/7CjxRVS0Yy6smq7nq47k.png",
  ...
  const SettingSecure  = () => ({
    imageSrc:
      "https://file.rendit.io/n/IJEU8wIsRoTUFFzTDOoL.png",
  ...
  const TurnOnMFA  = () => ({
    imageSrc:
      "https://file.rendit.io/n/EZHRphlQ2hHCDTus60Br.png",
    category: "MFA Authentication",
    date: "13 June 2023",
    title: "MFA Authentication",
    description: "Learn how to better protect yourself against cyber attacks by setting up MFA",
    url: "https://reddit.com"
    ...
    const RecogniseScams  = () => ({
      imageSrc:
        "https://file.rendit.io/n/PEFFNLRp8ZuGYCRpxxoO.png",
      category: "Scams",
      date: "13 June 2023",
      title: "Recognizing and Reporting Scams",
      description: " Recognizing Scams and what to do if you become a victim of one",
      url: "https://reddit.com"
  ...
  const Phishing  = () => ({
    imageSrc:
      "https://source.unsplash.com/bCrM2e1M0a4",
    category: "Phishing",
    date: "13 June 2023",
    title: "Phishing",
    description: "Learn about Phishing and how you can protect yourself from Phishing",
    url: "https://reddit.com"
