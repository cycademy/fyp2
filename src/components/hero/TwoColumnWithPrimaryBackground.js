...
export default ({
  ...
  primaryButtonUrl = "/components/pages/Signup.js",
  ...
  const logoLink = (
    <LogoLink href="/">
    <img src= "https://file.rendit.io/n/NoWgEidXFw3pOwdOnnAr.png"  />
</LogoLink>
  );
  ...
  const navLinks = [
    <NavLinks key={1}>
      ...
      <PrimaryLink href="/components/innerPages/SignupPage">    Sign Up</PrimaryLink>
    </NavLinks>
  ];
  return (
